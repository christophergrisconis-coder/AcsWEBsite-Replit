# Consuming Organic in Expo apps

Read `artifacts/organic/docs/AGENTS.md` first. React Native does
...
`artifacts/organic/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/organic/tokens";
...
```tsx
import { nativeTheme } from "@workspace/organic/lib/native-theme";
import { useColors } from "@workspace/organic/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/organic/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/organic/components/native/badge";
import { Button } from "@workspace/organic/components/native/button";
import { Card } from "@workspace/organic/components/native/card";
```
...
Import and render
`@workspace/organic/components/native/button`, then run Expo
