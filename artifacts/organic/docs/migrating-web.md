# Migrating web UI to Organic

Read `artifacts/organic/docs/AGENTS.md` and
`artifacts/organic/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/organic/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/organic/lib/utils`
- `@/hooks/use-toast` → `@workspace/organic/hooks/use-toast`
